...
yaml_file = "/deac/csc/vanbastelaerGrp/guptd23/csc790_AI/Project/Final_Code/config/helmet_rtdetr.yaml"
...
for label in labels:
    ...
    for line in lines:
        # classes for RTDETR label uses integer at first position of each line
